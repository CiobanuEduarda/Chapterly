...
// Generate books
async function generateBooks(categories) {
    ...
    for (let i = 0; i < NUM_BOOKS; i++) {
        ...
        books.push({
            ...
            genre: faker_1.faker.helpers.arrayElement(categories).name,
...
async function generateReviews() {
    ...
    for (let i = 0; i < NUM_REVIEWS; i++) {
        ...
        reviews.push({
            ...
            rating: randomNumber(1, 5),
            bookId: faker_1.faker.helpers.arrayElement(books).id,
        });
        // Insert in batches
...
async function assignCategoriesToBooks(categories) {
    ...
    for (const book of books) {
        ...
        const selectedCategories = faker_1.faker.helpers.arrayElements(categories, numCategories);
...
main();
//# sourceMappingURL=seedLarge.js.map