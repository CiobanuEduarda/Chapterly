...
const initialState: BookState = {
  books: [
    { id: 1, title: "The Great Gatsby", author: "F. Scott Fitzgerald", genre: "Classic", price: 12.99, rating: 4 },
    { id: 2, title: "To Kill a Mockingbird", author: "Harper Lee", genre: "Fiction", price: 10.99, rating: 5 },
    { id: 3, title: "1984", author: "George Orwell", genre: "Dystopian", price: 9.99, rating: 4 },
    { id: 4, title: "Pride and Prejudice", author: "Jane Austen", genre: "Romance", price: 8.99, rating: 3 },
  ],
}
